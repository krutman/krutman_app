...
describe User do
  ...
  describe "following" do
    ...
    describe "followed user" do
      subject { other_user } #замена объекта тестирования
  ...
  describe "with admin attribute set to 'true'" do
    before do
      @user.save!
      @user.toggle!(:admin) #изменяет атрибут от false к true
    end

    it { should be_admin } #класс должен иметь булев метод admin? - добавляется при миграции автоматически
  end
